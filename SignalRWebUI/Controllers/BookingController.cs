...
using SignalRWebUI.DtoViewModels.BookingDto;
using System.Text;
...
namespace SignalRWebUI.Controllers
{
    public class BookingController : Controller
    {
        ...
        public async Task<IActionResult> CreateBooking(CreateBookingDto createBookingDto)
        {
            ...
            createBookingDto.BookingTime = Convert.ToDateTime(DateTime.Now.ToString("dd/MM/yyyy"));
            var client = _httpClientFactory.CreateClient();
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7235/api/Booking/BookingStatusApproved/{id}");
            return RedirectToAction("Index");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7235/api/Booking/BookingStatusCancelled/{id}");
            return RedirectToAction("Index");
        }
    }
}
